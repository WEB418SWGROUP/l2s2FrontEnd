...
import New from './../component/Header/Header';
import New2 from "../component/Body/Body";
import New1 from "../component/Footer/Footer";
const AskQuestion = () => {
        ...
        if (validate()) {
            try {
                ...
                const res = await axios.post(
                    "http://localhost:9001/questions/saveAttachment",
                    formData1
                );
                ...
                var res2= await axios.post("http://localhost:9001/questions/addQuestion", values, { headers });
               alert(res2.data);
            } catch (ex) {
                console.log(ex);
            }
